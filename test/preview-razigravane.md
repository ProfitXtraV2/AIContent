> 👁️ **Преглед** — как изглежда статията с вградената инфографика. Само за преглед; не сливай.
...
![Инфографика: как множителят по базата дава изисквания оборот — при депозит €100 и 100% бонус с множител x30 базата само бонус дава €3000, а базата депозит+бонус дава €6000; принос на игрите — ротативки 100%, маси и на живо 10–20%](images/razigravane-mnozhitel-baza-oborot-preview.png)

*Инфографика (в реалната статия се вгражда като 6 KB SVG — тук показана като PNG за преглед). Числата са примерни, за илюстрация.*
