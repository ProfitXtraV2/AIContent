# 07 — Gemini external check, pass 1 (видеопокер)

Command: python3 scripts/gemini_check.py articles/2026-09-25-videopoker-pravila-variatsii/05b-final-draft.md

RESULT: GEMINI_UNAVAILABLE (exit 2)
Verbatim error:
  GEMINI_ERROR: HTTP 402 — "Your prepayment credits are depleted... RESOURCE_EXHAUSTED"

Interpretation per daily-run.md Step 7: API down (billing/credits), NOT a content signal.
