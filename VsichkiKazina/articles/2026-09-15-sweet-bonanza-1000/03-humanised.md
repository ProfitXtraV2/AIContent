# 03 — Humaniser pass (BG)

**Changes applied (voice-preserving, numbers untouched):**
1. Removed signposting lead-in „Ето какво значи това в евро:" — the euro paragraph now starts with the number directly.
2. Rewrote the „не A, а B" antithesis close in the 25,000x section („не подобрява…, а само разтяга") into two plain sentences: „По-високият таван прави едрата печалба по-рядка. Шансовете ти на едно завъртане остават същите като преди."
3. Trimmed the H2 „Множителите-бомби до 1,000x: същинската разлика" to „Множителите-бомби до 1,000x" and reworded the opener „Единственото, което наистина отличава" → „Промяната, заради която версията носи 1000 в името си" to avoid the demonstrative-emphasis tell.
4. Added „разпределени върху много завъртания" and „а не цел за една сесия" to soften two staccato lines; varied paragraph endings so no section closes on an aphorism.
5. Verbatim 18+ line kept in the RG section; asymmetric verdict kept in „За кого е".

**Self-check (author.md ANTI-AI list):** em-dashes 0 · no signposting lead-ins · „не A, а B" antithesis used 0 times as a paragraph-ender (contrast survives only in the heading „удобство, не предимство") · no „именно/точно тази/точно затова" · no label-before-explanation · no numbered prose · no „звучи като X… но Y" · no translated metaphors · no symmetric „колкото по-X, толкова по-Y" · varied paragraph shapes (no 3 consecutive same-structure sections) · asymmetric opinionated ending. PASS.
