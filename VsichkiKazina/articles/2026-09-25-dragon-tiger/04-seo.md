# 04-SEO — Всички Казина · vk-0175 (Дракон Тигър)

## SEO AUDIT
Target query: Дракон Тигър (Dragon Tiger): правила, залози и шансове | Intent: informational | Format match: yes (definitional/how-it-works first, cost/edge second, verdict last)

Relevance score: 94/100
(Query alignment 24/25 | Entity coverage 34/35 | Subtopic completeness 24/25 | On-page 12/15)

Query placement: „Дракон Тигър" в title, H1, първите 100 думи, H2 („Има ли стратегия за Dragon Tiger"), meta. „dragon tiger правила" / „dragon tiger стратегия" покрити чрез H2 и латински вариант в H1. Once each, no flooding.

MISSING ENTITIES: none of importance. All present: Дракон, Тигър, Равенство/Tie, Suited Tie, ранг/боя, тесте, домашно предимство, изплащания 1:1/8:1/11:1/50:1, RNG, казино на живо, демо режим, бакара (сравнение), блекджек (сравнение), броене на карти, Мартингейл.
SEMANTIC GAPS: closed — реалната € цена по залог, защо основният залог е евтин (½ залог при равенство), контраст с бакара Банко, RNG срещу живо срещу демо.
FLOODING/OVER-OPTIMISATION DEFECTS: none. Primary keyword в ≤3 heading-а. No doorway intro.
ON-PAGE FIXES: title/meta added below. Heading hierarchy: single H1, eight H2, no skipped levels.
INTERNAL LINKS (already woven, formalised — no add/remove): [методологията ни → /kak-ocenyavame/], [гайда за бакара → /blog/bakara-pravila/], [казино игрите → /kazino-igri/], [инструментите за отговорна игра → /otgovorna-igra/]. 4 links, all from the approved/sibling set.
SCHEMA: Article + Person (author Георги Тодоров). No FAQPage (no genuine FAQ block). No Review schema (not an operator review).

NUMBER DIFF 03→04: identical. Voice preserved; no new sentences added to the body (links already present in author voice).

═══════════════════════════════════

Title tag: Дракон Тигър: правила, залози и шансове
Meta description: Дракон Тигър (Dragon Tiger) накратко: правилата, залозите Дракон, Тигър и равенство, изплащанията и домашното предимство по залог. Защо равенството е капан.

---

# Дракон Тигър (Dragon Tiger): правила, залози и шансове

Дракон Тигър е бакара, свита до най-простото си ядро. Раздават се две ръце, Дракон и Тигър, всяка получава по една карта, и по-високата печели. Няма правило за трета карта, няма събиране на сборове, няма решения за вземане. Основният залог струва около 3,73% домашно предимство, което е поносимо, но залогът на равенство крие цели 32,77% и той примамва новите играчи. Заради това темпо и заради едно единствено правило играта се учи за трийсет секунди и се играе почти изцяло по рефлекс.
...
Печеливш залог на Дракон плаща 1:1, същото важи и за Тигър. Равенството, когато двете карти излязат с еднакъв ранг, обикновено плаща 8:1, а на някои маси и варианти 11:1. Има и четвърти залог, Suited Tie, който иска двете карти да съвпаднат по ранг и по боя едновременно и плаща 50:1. Едно правило променя цялата сметка на основния залог: заложите ли на Дракон или Тигър и се падне равенство, губите половината от залога, а не целия. Банерът рядко изтъква този детайл, но той е договорът и оттам казиното изгражда предимството си.
...
## CHANGE SUMMARY
1. Added title tag (39 chars core) + meta description (156 chars); „Дракон Тигър" front-loaded.
2. Formalised 4 internal links already present in author voice; none added/removed.
3. No entity gaps to fill; no filler added; body identical to 03.
4. Schema recommendation: Article + Person.
5. NUMBER DIFF 03→04: identical.
