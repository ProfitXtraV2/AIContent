...
![Абстрактна мрежа от барабани със символи, в чийто център стои празен wild символ със стрелки към съседните символи (череша, звезда и диамант), за да покаже как wild заема тяхната стойност](images/wild-simvoli-hero.webp)
