Byline: Editorial (signed Георги Тодоров) | Market: bg — provider profile, neutral reference; no testing receipts, no persona anecdote
...
CANON ADDITIONS: none (editorial voice; no persona anecdote, no invented biography).

FLAGS:
- [VERIFY] точен брой заглавия в портфолиото на Evoplay (игровите каталози: над 250; собственият сайт не дава единично число) — в текста хеджирано като "над 250" / "приемай го като порядък".
- [VERIFY per-casino] реалният RTP билд на Dungeon: Immortal Evil (официално 96.07%; външни бази посочват версия ~95%) — операторът избира; провери в инфо-панела.
