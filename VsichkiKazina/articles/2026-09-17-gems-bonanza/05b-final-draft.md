...
По-важно от процента е темпераментът. Волатилността е висока, оценена 5/5 по скалата на Pragmatic, тоест игра, в която печалбите идват по-рядко, но на по-едри порции. Според един източник честотата на печалба е около едно на три завъртания, но това число го дава само той, затова го приемай като ориентир, не като гаранция [VERIFY: честота на печалба ~1/3, единствен източник]. На практика високата волатилност значи дълги серии без нищо, прекъсвани от отделни по-големи попадения, и банка, която трябва да издържи на сухите периоди. Максималната печалба е 10 000 пъти залога, което е таван, а не очакване. Залогът е между €0.20 и €100 на завъртане.
