BRAND COMPLIANCE SCORECARD — Множители в ротативките: как работят и кога умножават печалбата
...
MODERATE / MECHANICAL FIXES APPLIED:
- Trust slots were placeholders: inserted the verbatim RG footer block (18+ line + /otgovorna-igra/ + национален регистър на уязвимите лица + „Солидарност" 0888 99 18 66) and the verbatim 1-Aug-2026 affiliate-licensing disclosure. About Всички Казина boilerplate slot kept as the house placeholder token.
- Confirmed brand name written exactly „Всички Казина" (appears in the affiliate + RG blocks); no transliteration anywhere.
- Recalculated every figure for internal consistency: €0.20 × x2 = €0.40 ✓; €0.20 × x100 = €20 ✓; Gonzo base ladder 1x/2x/3x/5x with 4th consecutive = 5x ✓; Free Falls 10 spins 3x/6x/9x/15x ✓; RTP 95.97% ✓; Sweet Bonanza 2x–100x, free spins only, 2019 ✓; Gates up to 500x, accumulating in free spins, 6×5, 8+ pay-anywhere ✓. All match source brief exactly.
- Превъртане stated with its base (депозит+бонус vs само бонус) in S7 ✓ — not a floating multiplier.
- Illustrative € figures labelled „примерни" ✓ (S1, S2, S6). No invented RTP, max-win, operator fact, or licence number.

VERIFY QUEUE (route to human): none. No tax claim made; no operator recommended or scored (guide, not review), so no НАП licence № required; site-licence status stated as pending in the affiliate footer.

VOICE NOTES (protect during fixes): asymmetric verdict on x500 = volatility not value; dry patient-teacher register; do not re-tone. Left the single intact „не A, а B" contrast (intro) alone as within budget.

INTERNAL LINK CHECK: 4 in-body links all from the brief's approved live set (/blog/rechnik-kazino-termini/, /blog/sweet-bonanza/, /blog/progresivni-dzhakpoti/, /blog/kak-raboti-razigravaneto/) + /otgovorna-igra/ in RG. Gonzo's Quest and Gates of Olympus correctly in plain text (not yet live), only Sweet Bonanza linked. No affiliate/operator link needed (no operator referenced for signup).

EM-DASH SWEEP: 0 em-dashes (—) in the article. (En dash „–" only inside the verbatim RG phone-line hours „10:00–17:00", which is the hard-coded untouchable block.)
