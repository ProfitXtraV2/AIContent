# 07 — Gemini external check, pass 1 (Pai Gow Poker)

Command: python3 scripts/gemini_check.py VsichkiKazina/articles/2026-09-26-pai-gow-poker/05b-final-draft.md
