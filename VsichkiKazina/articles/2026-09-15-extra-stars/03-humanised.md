HUMANISER PASS — anti-AI style check applied. Killed: nothing structural required (no „не A, а B" paragraph endings, no „именно тази/точно затова", no label-before-explanation, no numbered prose, no translated metaphors, no symmetric „колкото по-X, толкова по-Y", no rule-of-three negations). Em-dash count: 0. Paragraph shapes varied across 7 sections. Ending is an asymmetric verdict. Numbers unchanged from 02.
