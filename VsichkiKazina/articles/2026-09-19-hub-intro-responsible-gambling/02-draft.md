Byline: Editorial Team (Екипът на Всички Казина voice) | Market: BG — RG content defaults to the solidarity/editorial register per author.md tie-breakers; no first-person testing evidence applies (this is not a review). Published byline is fixed to Георги Тодоров by the brand override, outside this 350–500 word body.
...
Footer placeholders: [EDITORIAL — byline rendered as Георги Тодоров by site template/meta, outside body] [BRAND BOILERPLATE — n/a, hub-intro body only] [18+ / RG LINE — inline above, verbatim]

CANON ADDITIONS: none.
[DATA NEEDED] flags: none.

QUALITY GATE self-check: anti-AI style pass (em-dash budget: zero em-dashes used; no signposting lead-ins; two sections have different internal shapes — Section 1 builds narrative → warning signs → help pointer, Section 2 opens with the licence fact directly and closes on an asymmetric verdict; ending is opinionated, not balanced-both-sides); right language/currency/regulator (Bulgarian, НАП, no cross-market contamination); word count ≈358 (within 350–500).
