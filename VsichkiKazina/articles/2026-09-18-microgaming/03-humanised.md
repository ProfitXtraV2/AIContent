# 03-HUMANISED — 2026-09-18-microgaming (vk-0112)

## Phase 1 — AI-fingerprint evaluation
Verdict: **MIXED (light touch)**. Draft is already in the editorial register with varied section shapes. Fixes applied:
- Checked the „не A, а B" antithesis (top BG tell): kept to two deliberate uses (the progressive-pool point + the closing verdict, which is house style for these provider hubs). No per-paragraph habit.
- No banned connectives (освен това / в допълнение / в заключение / заслужава да се отбележи) present.
- No signposting lead-ins („Причината е проста", „Ето каква е уловката", „Нека сметнем"). One reveal-ish phrase removed: none needed.
- No demonstrative-amplifier stacking („именно тази" used once, kept).
- Varied paragraph architecture: §1 flowing, §2 clarification, §3 mechanics walk, §4 caveat with the 18+ line, §5 data, §6 short, §7 asymmetric close. No 3 consecutive same-shape sections.
- 0 em-dashes in body. En-dash only in the verbatim footer „10:00–17:00".
- Numbers unchanged from 02: 1994, 1998, 2022, 2021, 88.12%, £13,213,838.68, €17,879,645.12, 06.10.2015, 2019, 96.86%, 2011, 96.65%, 2010, 95.43%, 2008, 2006, 243.

Rewrite: minor rhythm variation only (one sentence merged in §3 to avoid a spec-list cadence; „а не късметът на екрана" kept as the single mid-piece contrast). Voice preserved. Article below.
