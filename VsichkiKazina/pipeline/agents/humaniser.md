...
No signposting lead-ins. Just say the thing. Start a calculation with the numbers, not with a label introducing the calculation. (BG, confirmed Gemini 2026-09-07: also „Причината е проста:", „Логиката … е проста:", „Изводът е прост:", „Правилото е просто:", „Има и нюанс:", and counting signposts „Има и още две неща…", „Втората спънка е…". BG, confirmed Gemini 2026-09-21 — 6/30, mostly provider-hub profiles: also the „roadmap"/table-of-contents intro that maps what the whole article will cover — „Тук ще намерите кой стои зад студиото…", „По-долу е важното за механиката…", „Ето как работи всичко това на практика.", meta „Тази категория събира…". Delete it; open on the first concrete fact.)
