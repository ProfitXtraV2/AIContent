...
No signposting lead-ins. Just say the thing. Start a calculation with the numbers, not with a label introducing the calculation. (BG, confirmed Gemini 2026-09-07: also „Причината е проста:", „Логиката … е проста:", „Изводът е прост:", „Правилото е просто:", „Има и нюанс:", and counting signposts „Има и още две неща…", „Втората спънка е…".) (BG, confirmed Gemini 2026-09-14 — the most-flagged family this batch, 7/30: the reveal/honesty pivot „Тук е честната/практичната част…", „Тук идва/се крие разликата…", „Дотук нищо нестандартно, разликата идва от…", and self-justifying meta-commentary „Разказвам го, защото показва…". Delete it; start on the fact.)
...
NO NARRATED EMOTION: replace "Was mich genervt hat: X" with a direct statement of the problem and its consequence. Irritation lives in word choice and verdict, never in a sentence announcing "I felt X." (BG, confirmed Gemini 2026-09-10: also the READER-directed variant — presumptive 2nd person „свикваш да…/струва ти се…", „За теб това значи…"/„За теб като играч…" framing, preachy imperatives „гледай на X като на Y, не като на Z" and „перфектно за играчи, които…" persona-endings. State the game-design fact objectively; no „ти", no order.) (BG, confirmed Gemini 2026-09-14: also the IMPERSONAL value-judgment variant — „Струва си да…", „По-полезно е да приемеш играта такава, каквато е", „демо режимът е честният начин да…", „Полезно е да познаваш имената". State the fact and let the reader judge its worth; no „струва си", no „честният начин".)
...
NO FALSE CLIMAXES: cut manufactured-tension phrases before a point. Deliver the complicated part immediately. (BG, confirmed Gemini 2026-09-14: also the dramatic colon-drop setup that manufactures suspense before a colon — „…има цена, и тя е волатилността"; „За сметката ти значение има само едно:"; „…и точно там е капанът:". Integrate the point into the sentence flow; no drumroll into a colon.)
